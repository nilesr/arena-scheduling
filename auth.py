...
def try_login(email, name):
	...
	if email in ["mcdasethan@gmail.com"]:
		email = "1009439@apsva.us"
	if email in ["wsavage6316@gmail.com", "wskj.games@gmail.com", "woodlawnarena@gmail.com"]:
		email = "997968@apsva.us"
